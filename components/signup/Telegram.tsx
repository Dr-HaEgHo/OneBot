...
const Telegram = () => {
  ...
  return (
    <div>
        <p className='text-textBody w-[70%] mx-auto text-links lh-150 text-center mb-6'>Click the button below to open Telegram app on the desktop. When Telegram chat is opened, click 'Start'.</p>
        <FilledButton
            cta={() => {router.push('/connect-page/telegram?page=1')}}
