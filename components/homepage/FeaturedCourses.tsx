    ...
    return (
        <div className='w-full py-16 flex max-lg:flex-col-reverse items-center gap-6' >
            <div className='w-full lg:w-[40%]' >
                <span className='text-[10px] xl:text-xs leading-[12px] xl:leading-[14px] tracking-[15px] text-labelGrey'>LEARN WITH onebot</span>
                <h3 className='text-[32px] xl:text-[40px] text-primary2 mb-2 font-[700]'>Featured Courses</h3>
                <p className='text-xs xl:text-sm font-400 leading-[20px] xl:leading-[25px] text-labelGrey mb-6'> Discover the power of forex trading with onebot Academy.
